      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ marginBottom: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Compete with students across Sri Lanka and climb the ranks!
          </Typography>
        </Box>
        ...
        <Grid container spacing={3} sx={{ marginBottom: 3 }}>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={3} sx={{ padding: 2, textAlign: 'center', borderRadius: 3 }}>
              ...
              <Typography variant="body2" color="text.secondary">Schools Participating</Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper elevation={3} sx={{ padding: 2, textAlign: 'center', borderRadius: 3 }}>
                ...
                <TableBody>
                  {schoolLeaders.map((leader) => (
                    <TableRow key={leader.rank} hover>
                      ...
                      <TableCell align="center">Grade {leader.grade}</TableCell>
                      <TableCell align="center">
                        <Chip
                          icon={<Star />}
                          label={`Level ${leader.level}`}
